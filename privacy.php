    ...
    <div class="content">
      ...
      <div class="doc-section" id="p1">
        ...
        <table class="data-table">
          ...
          <tr>
            <td>Data Akun</td>
            <td>Nama, email, password terenkripsi</td>
            <td>Identifikasi pengguna</td>
          </tr>
          <tr>
            <td>Data Undangan</td>
            <td>Nama pengantin, tanggal, lokasi</td>
            <td>Pembuatan undangan</td>
          </tr>
          <tr>
            <td>Data Kontak</td>
            <td>Nomor WhatsApp, email</td>
            <td>Notifikasi & komunikasi</td>
          </tr>
          <tr>
            <td>Data Teknis</td>
            <td>IP address, jenis browser</td>
            <td>Keamanan & analitik</td>
          </tr>
        </table>
      </div>
